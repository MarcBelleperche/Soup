...
public class Potatoe extends Vegetable {
    ...
    public String toString(){
        ...
        if (eyes>1)  Affichage = "Patate :["+getCalories()+" calories - "+weight+" kg - "+eyes+" yeux]";
        else if (eyes == 1) Affichage = "Patate :["+getCalories()+" calories - "+weight+" kg - "+eyes+" oeil]";
        return Affichage;}
    ...
    public int getCalories(){
        int Calories = (int) Math.ceil(((weight -(getPeelingweightleg()))/(0.1))*80);
        Calories = Calories - eyes*5;
        return Calories;
    }
